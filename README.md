...
**Make easier to read code, and avoid duplicate code. For example, if code is practically duplicated, it could be made into a function to be called. Also, clear names in variables are really useful. Clear names and functions can be understood without the need of comments to explain the code**
